...
const CODE_SYSTEM = [
    ...
    '12. DO NOT STOP AT THE FIRST ERROR. Keep fixing and retrying until SUCCESS.',
    '13. IF THE ERROR SOLUTION IS OBVIOUS (e.g. "install sweetalert2"), JUST DO IT. DO NOT explain the error back to the user.',
    '',
