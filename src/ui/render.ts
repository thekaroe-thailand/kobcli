...
const COMMANDS: [string, string, string][] = [
    ...
    ['/config-info', 'Show current configuration', C.pink],
    ['/config:model', 'Change default model', C.amber],
    ['/config:provider', 'Change API provider URL', C.pink],
    ['/config:key', 'Change API key', C.pink],
